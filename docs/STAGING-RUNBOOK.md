...
| --- | --- | --- |
| `BASE_URL` | `https://rag-staging.example.com` | Staging backend URL. |
...
9. Check `/actuator/prometheus` and Prometheus targets for the application label `campus-rag-qa`.
...
```text
https://rag-staging.example.com?apiToken=<rotated-user-token>
```
